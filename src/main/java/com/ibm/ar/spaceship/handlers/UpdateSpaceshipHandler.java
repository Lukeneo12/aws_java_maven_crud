...
public class UpdateSpaceshipHandler implements RequestHandler<Map<String, Object>, ApiGatewayResponse> {

	private static final Logger LOG = LogManager.getLogger(UpdateSpaceshipHandler.class);
	...
	public ApiGatewayResponse handleRequest(Map<String, Object> input, Context context) {
        ...
        Map<String, Object> response = repository.updateSpaceshipById(spaceshipId, input);
